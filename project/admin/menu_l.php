...
<div class="list-group">
	...
	<a href="index.php?act=log_login" class="list-group-item">ประวัติการเข้าสู่ระบบ</a>
	<a href="problem.php" class="list-group-item">ปัญหา</a>
	<a href="../logout.php" onclick="return confirm('ออกจากระบบ?');" class="list-group-item list-group-item-danger">ออกจากระบบ</a>
</div>