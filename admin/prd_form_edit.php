...
<form action="prd_form_edit_db.php" method="post" class="form-horizontal" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2">
      <input type="number" name="p_price" min="1" required class="form-control" value="<?php echo $row['p_price'];?>">
    </div>
  </div>
  <div class="form-group">
    <div class="col-sm-2 control-label">
    ...
    <div class="col-sm-2">
      <input type="number" name="p_qty" min="1" max="100" required class="form-control" value="<?php echo $row['p_qty'];?>">
    </div>
  </div>
